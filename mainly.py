...
class HOTEL_MANAGEMENT:
    ...
    def __init__(self):
        ...
        font14 = "-family {Segoe UI} -size 15 -weight bold -slant "  \
            "roman -underline 0 -overstrike 0"
        font16 = "-family {Swis721 BlkCn BT} -size 40 -weight normal "  \
            "-slant roman -underline 0 -overstrike 0"
        font9 = "-family {Segoe UI} -size 9 -weight normal -slant "  \
            "roman -underline 0 -overstrike 0"
        ...
        root.configure(highlightbackground="#d9d9d9")
        root.configure(highlightcolor="black")
        background_image=PhotoImage(file='11.png')
        ...
        self.Frame1.configure(borderwidth="2")
        self.Frame1.configure(relief=GROOVE)
        self.Frame1.configure(background="midnight blue")
        self.Frame1.configure(highlightbackground="#d9d9d9")
        self.Frame1.configure(highlightcolor="black")
        self.Frame1.configure(width=925)

        self.Message6 = Button(root)
        self.Message6.place(relx=0.39, rely=0.01, relheight=0.15, relwidth=0.36)
        self.Message6.configure(background="#d9d9d9")
        self.Message6.configure(font=font16)
        self.Message6.configure(foreground="#000000")
        self.Message6.configure(highlightbackground="#d9d9d9")
        ...
        self.Message6.configure(image=photo, compound=CENTER)'''

        self.Button2 = Button(root)
        self.Button2.place(relx=0.1, rely=0.19, height=93, width=366)
        self.Button2.configure(activebackground="#d9d9d9")
        self.Button2.configure(activeforeground="#000000")
        self.Button2.configure(background="#d9d9d9")
        self.Button2.configure(disabledforeground="#bfbfbf")
        ...
        self.Button2.configure(width=566)
        photo=PhotoImage(file="kk.gif")
        self.Button2.configure(image=photo, compound=CENTER)
        self.Button2.configure(command=click_checkinn)

        self.Button3 = Button(root)
        self.Button3.place(relx=0.1, rely=0.33, height=93, width=366)
        self.Button3.configure(activebackground="#d9d9d9")
        self.Button3.configure(activeforeground="#000000")
        self.Button3.configure(background="#d9d9d9")
        self.Button3.configure(disabledforeground="#bfbfbf")
        ...
        self.Button3.configure(width=566)
        #photo=PhotoImage(file="KK.gif")
        self.Button3.configure(image=photo, compound=CENTER)
        self.Button3.configure(command=click_list)

        self.Button4 = Button(root)
        self.Button4.place(relx=0.1, rely=0.47, height=93, width=366)
        self.Button4.configure(activebackground="#d9d9d9")
        self.Button4.configure(activeforeground="#000000")
        self.Button4.configure(background="#d9d9d9")
        self.Button4.configure(disabledforeground="#bfbfbf")
        ...
        self.Button4.configure(width=566)
        #photo=PhotoImage(file="KK.gif")
        self.Button4.configure(image=photo, compound=CENTER)
        self.Button4.configure(command=click_checkout)

        self.Button5 = Button(root)
        self.Button5.place(relx=0.1, rely=0.61, height=93, width=366)
        self.Button5.configure(activebackground="#d9d9d9")
        self.Button5.configure(activeforeground="#000000")
        self.Button5.configure(background="#d9d9d9")
        self.Button5.configure(disabledforeground="#bfbfbf")
        ...
        self.Button5.configure(highlightcolor="black")
        self.Button5.configure(pady="0")
        self.Button5.configure(text='''GUEST NFORMATON''')
        self.Button5.configure(width=566)
        self.Button5.configure(command=click_getinfo)
        #photo=PhotoImage(file="KK.gif")
        self.Button5.configure(image=photo, compound=CENTER)

        self.Button6 = Button(root)
        self.Button6.place(relx=0.1, rely=0.75, height=93, width=366)
        self.Button6.configure(activebackground="#d9d9d9")
        self.Button6.configure(activeforeground="#000000")
        self.Button6.configure(background="#d9d9d9")
        self.Button6.configure(disabledforeground="#bfbfbf")
        ...
        self.Button6.configure(width=566)
        #photo=PhotoImage(file="KK.gif")
        self.Button6.configure(image=photo, compound=CENTER)
        self.Button6.configure(command=quit)
        root.mainloop()
