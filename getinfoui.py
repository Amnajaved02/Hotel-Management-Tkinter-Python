...
class HOTEL_MANAGEMENT(save):         ##INHERITANCE
    def __init__(self):
        ...
        root.geometry("1000x900+249+104")
        ...
        self.Text1.configure(highlightbackground="black")
        ...
        self.Message1.configure(text='''GET YOUR INFO HERE!!''')
        self.Message1.configure(width=460)
        root.mainloop()
        
    def get_info():   ##POLYMORPHISM
        pass
